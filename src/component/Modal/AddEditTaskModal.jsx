    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            className=" w-full items-center dark:text-green-600 dark:bg-white  text-white bg-green-600 py-2 rounded-full "
            onClick={() => {
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            ...
            className=" w-full items-center text-white bg-green-600 py-2 rounded-full "
          >
