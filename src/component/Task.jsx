  ...
  return (
    <div className="">
      <div
        ...
        className=" w-[280px] first:my-5 rounded-lg  bg-white  dark:bg-[#121312] shadow-[#163F2B1A] py-6 px-3 shadow-lg hover:text-green-600 dark:text-white dark:hover:text-green-600 cursor-pointer "
      >
